...
class Container_e49b4313af extends _PHPStan_7c49c944c\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService047(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_e49b4313af $container)
			{
	...
	public function createServiceContainer(): Container_e49b4313af
	{
		return $this;
	}
